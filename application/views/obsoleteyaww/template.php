...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>assets/AdminLTE-2.4.3/index2.html" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>assets/AdminLTE-2.4.3/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo base_url();?>assets/AdminLTE-2.4.3/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
		  ...
		  <p>https://tamam.edunamika.com/codeigniter-tutorial-integrasi-adminlte-dengan-codeigniter-bagian-1/</p>
		  <p>https://tamam.edunamika.com/codeigniter-tutorial-integrasi-adminlte-dengan-codeigniter-bagian-2/</p>
        </div>
        <!-- /.box-body -->
